...
public class DragDrop1 {
	...
	public static void main(String[] args) {
		...
		DragDrop1.dragDropActions(capital_Washington, country_UnitedStates, driver);
		DragDrop1.dragDropActions(capital_Rome, country_Italy, driver);
		DragDrop1.dragDropActions(capital_Madrid, country_Spain, driver);
